<?php
    ...
    $sql = "SELECT * FROM item_found where item_category = 'Book' AND item_status = 'READY TO COLLECT'";
...
<body> 
    ...
    if(isset($_POST['search'])){
        $key = $_POST['search'];
        $query = "SELECT * FROM item_found WHERE item_category = 'Book' AND item_status = 'READY TO COLLECT' AND item_name LIKE '$key' ORDER BY item_name ASC";
