      ...
      <div class="info">
            ...
            <div class="info_data"> 
              <form action="export.php" method="POST">
                <div class="export">
                  <button type="submit" name="export_excel" class="button">Export</button>
                </div>
              </form>
            <table>
                  <thead>
                  ...
                  <tbody>
                    <?php 
                      if(isset($_POST['search'])){
                        $key = $_POST['search'];
                        $query = "SELECT * FROM item_found WHERE item_status = 'Collected' AND item_name LIKE '$key'";
                    ...
                    <?php } ?>
                    <?php } else {  
                      $sql = "SELECT * FROM `item_found` WHERE item_status = 'Collected'";
                    ...
                    <?php }} else {?>
                      <tr>
                        <td colspan="7">No Complete Item Available</td>
                      </tr>
                    <?php }}?>
                  </tbody>
                </table>
