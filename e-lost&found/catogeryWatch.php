<?php
    ...
    $sql = "SELECT * FROM item_found where item_category = 'Watch' AND item_status = 'READY TO COLLECT'";
...
<head>
    ...
    <title>eLF - Category Watch</title>
...
<body> 
    ...
    if(isset($_POST['search'])){
        $key = $_POST['search'];
        $query = "SELECT * FROM item_found WHERE item_category = 'Watch' AND item_status = 'READY TO COLLECT' AND item_name LIKE '$key' ORDER BY item_name ASC";
