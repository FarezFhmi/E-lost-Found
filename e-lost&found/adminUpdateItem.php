        ...
        <div class="info">
          ...
          <input type="hidden" name="item_id" value="<?php echo $row['item_id'];?>" />
            ...
            <div class="info_data">
                <div class="input-box"> 
                    <h4>Status : </h4>
                    <select class="selection" name="status" id="status">
                      <option value="none" selected disabled hidden><?php echo ucfirst($row['item_status']);?></option>
