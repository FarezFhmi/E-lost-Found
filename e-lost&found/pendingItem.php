        ...
        <div class="info">
          ...
          <input type="hidden" name="item_id" value="<?php echo $row['item_id'];?>" />
            ...
            <div class="info_data">
                <div class="input-box"> 
                    <h4>Name Found : </h4>
                    <input type="text" name="namefound" required />
                </div>
                <div class="input-box"> 
                    <h4>No Matrik : </h4>
                    <input type="text" name="matrixfound" required />
                </div>
                <div class="input-box"> 
                    <h4>No.Phone : </h4>
                    <input type="text" name="phonefound" required />
                </div>
                <div class="input-box"> 
                    <h4>Status : </h4>
                    <input type="text" name="status_item" value="Ready To Collect" readonly />
                </div>
            </div>
        </div>
