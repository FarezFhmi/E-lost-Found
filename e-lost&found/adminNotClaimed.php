                  ...
                  <tbody>
                    <?php 
                      if(isset($_POST['search'])){
                        $key = $_POST['search'];
                        $query = "SELECT * FROM item_found WHERE item_status = 'Ready To Collect' AND item_name LIKE '$key'";
                    ...
                    <?php }} else {?>
                      <tr>
                        <td colspan="7">All Item Has Been Claim</td>
                      </tr>
                    <?php }}?>
                  </tbody>
                </table>
